...
public class AnalysisController {
	...
	public List justTest(Model model, HttpServletRequest request) {
		String failureEquipment=request.getParameter("failureEquipment");//ʧЧ�豸
		String cateId=request.getParameter("cateId");//ʧЧ��ʽ��ʧЧ����
		String failureComponent=request.getParameter("failureComponent");//ʧЧ����
		String failureMaterial=request.getParameter("failureMaterial");//ʧЧ��������
