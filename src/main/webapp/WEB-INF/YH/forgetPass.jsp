...
<body>
	...
	<DIV
		...
		<P style="padding: 30px 0px 10px; position: relative;">
			email地址：<INPUT class="ipt" type="text" id="uemail"
				placeholder="请输入邮箱" value="">
		</P>
		<p>
			<span id="emailError" style="color: red; display: none">该邮箱还未被注册</span>
		</p>
...
<script type="text/javascript">
  var emailError = "<%=request.getAttribute("emailError")%>";
	if (emailError == "yes") {
		$("#emailError").show();
	} else
		$("#emailError").hide();
	...
	function getPassLink() {
		window.location.href = "YH/getPassLink?email=" + $("#uemail").val();
	}
</script>
</html>
