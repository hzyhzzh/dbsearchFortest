...
<body>
	...
	<div class="classification">
		<form>
			...
			<input id="materialclassify" type="button" class="button1" value="材料分类" onclick="step3_step4()">
		</form>		
	</div>
		...
		<% 
						...
						for(int i =0;i<resultList.size();++i)
						{
							...
							if((materialname.equals("其他")|| materialname.equals("其它")) && 
								...
								if(tag==1 && failureequipment.contains(failurequipment)
							...
							//失效设备为其他
								...
								if(materialinfo.contains(materialname) && failurebehave.contains(failurebehaviour)){
									...
									int tag = 1;
									for(DiagnoseField temp : test_equipment){
										if(failureequipment.contains(failurequipment)){
											tag = 0;
											break;
										}
